...
vc_map ( array (
	...
	"params" => array (
		...
		array(
			"type" => "dropdown",
			"class" => "",
			"heading" => __("Nav Position", 'consulta'),
			...
			"description" => __('Select position next/prev buttons.', 'consulta')
		),
		array(
			"type" => "dropdown",
			"class" => "",
		...
		array(
			"type" => "dropdown",
			"class" => "",
			"heading" => __("Dots Position", 'consulta'),
			...
			"description" => __('Select position dots navigation.', 'consulta')
		),
		array(
			"type" => "textfield",
			"class" => "",
