<?php
class consulta_Social_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'social_widget', // Base ID
                __('Socials', 'consulta'), // Name
                array('description' => __('Social Widget', 'consulta'),) // Args
        );
    }
...
/**
 * Class consulta_Social_Widget
 */
function consulta_register_social_widget() {
    register_widget('consulta_Social_Widget');
}
add_action('widgets_init', 'consulta_register_social_widget');
?>
