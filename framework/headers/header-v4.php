...
<?php 
	...
	if(isset($consulta_options['fixed_main_menu_v4']) && $consulta_options['fixed_main_menu_v4']) {
	...
	if($disable_stick_menu != 'on') {
		if(isset($consulta_options['stick_main_menu_v4']) && $consulta_options['stick_main_menu_v4']) {
...
<header>
	<div id="consulta_header" class="<?php echo esc_attr($class_header); ?>"><!-- bt-header-stick/bt-header-fixed -->
		...
		<div class="bt-header-top">
			<div class="container">
				<div class="row">
					<?php if (is_active_sidebar("consulta-header-top-v4-left")) { ?>
						<div class="bearsicon_tx bears-p1">
							<?php 
								dynamic_sidebar("consulta-header-top-v4-left");
							?>
						</div>
					<?php } ?> 
					...
					<?php if (is_active_sidebar("consulta-header-top-v4-right")) { ?>
						<div class="bearsicon_tx bears-p3">
							<?php 
								dynamic_sidebar("consulta-header-top-v4-right");
							?>
						</div>
					<?php } ?>
					<?php if (is_active_sidebar("consulta-header-top-sosial-right")) { ?>
						<div class="bearsicon_tx bears-p4">
							<?php 
								dynamic_sidebar("consulta-header-top-sosial-right");
							?>
						</div>
					<?php } ?>
				</div>
