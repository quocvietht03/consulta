...
<?php 
	...
	if(isset($consulta_options['fixed_main_menu_v7']) && $consulta_options['fixed_main_menu_v7']) {
	...
	if($disable_stick_menu != 'on') {
		if(isset($consulta_options['stick_main_menu_v7']) && $consulta_options['stick_main_menu_v7']) {
