...
<?php 
	...
	$class_header = 'bt-header-v2';
	if(isset($consulta_options['first_level_style_main_menu_v2']) && $consulta_options['first_level_style_main_menu_v2']) {
		$class_header .= ' '.$consulta_options['first_level_style_main_menu_v2'];
	}
	if(isset($consulta_options['fixed_main_menu_v2']) && $consulta_options['fixed_main_menu_v2']) {
	...
	if($disable_stick_menu != 'on') {
		if(isset($consulta_options['stick_main_menu_v2']) && $consulta_options['stick_main_menu_v2']) {
		...
		<div class="bt-header-menu">
			<div class="container bt-header-relative-style">
				<div class="row">
						...
						<div class="bt-header-clear-relative-style col-md-9 col-lg-7 col-sm-12 col-xs-12 bt-col-menu <?php if (is_active_sidebar("consulta-menu-right-sidebar")) echo esc_attr('has-menu-right-sidebar'); ?>">
							<?php
								$attr = array(
						...
						<?php if (is_active_sidebar("consulta-menu-right-sidebar-2")) { ?>
							<div class="col-md-2 right-bears-sose hidden-md">
								<?php 
									dynamic_sidebar("consulta-menu-right-sidebar-2");
								?>
							</div>
						<?php } ?>
