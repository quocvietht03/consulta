<?php
function consulta_products_grid_render($atts) {
				...
				<nav class="bt-pagination" role="navigation">
					<?php
						...
						echo paginate_links( array(
							...
							'prev_text' => __( '<i class="fa fa-angle-left"></i>', 'consulta' ),
							'next_text' => __( '<i class="fa fa-angle-right"></i>', 'consulta' ),
						) );
					?>
				</nav>
			<?php } ?> 
...
if(function_exists('bcore_shortcode')) { bcore_shortcode('products_grid', 'consulta_products_grid_render'); }