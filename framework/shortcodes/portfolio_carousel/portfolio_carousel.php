<?php
function consulta_portfolio_carousel_func($atts, $content = null) {
...
if(function_exists('bcore_shortcode')) { bcore_shortcode('portfolio_carousel', 'consulta_portfolio_carousel_func'); }
