<?php
function consulta_package_func($atts, $content = null) {
				...
				<div class="<?php echo esc_attr($class_columns); ?>">
					<article <?php post_class(); ?>>
						<div class="bt-package-item">
							<div class="bt-header">
								<?php 
									$price = get_post_meta(get_the_ID(),'consulta_package_price',true);
									$per_time = get_post_meta(get_the_ID(),'consulta_package_per_time',true);
				...
				<nav class="bt-pagination" role="navigation">
					<?php
						...
						echo paginate_links( array(
							...
							'prev_text' => __( '<i class="fa fa-angle-double-left"></i>', 'consulta' ),
							'next_text' => __( '<i class="fa fa-angle-double-right"></i>', 'consulta' ),
						) );
					?>
				</nav>
			<?php } ?>
...
if(function_exists('bcore_shortcode')) { bcore_shortcode('package', 'consulta_package_func'); }
