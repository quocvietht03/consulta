 ...
 *
 */
if( ! function_exists( 'consulta_wbc_importer_description' ) ) {
 function consulta_wbc_importer_description()
 {
  $output = "";
 ...
 add_filter('wbc_importer_description', 'consulta_wbc_importer_description' );
}