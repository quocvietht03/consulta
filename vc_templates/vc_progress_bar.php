...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<div class="vc_label"' . $line['txtcolor'] . '><div class="vc_inner" style="width: ' . esc_attr( $percentage_value ) . '%">' . '<span class="vc_label_title">' . $line['label'] . '</span>' . $unit . '</div></div>';
